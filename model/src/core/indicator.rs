use crate::{
    Auditable, BaseDataModel, BucketId, FactorOrSubjectDatasetColumnId, ModelErrorCode,
    OptimisticLock, ParameterJoint, Storable, TenantBasedTuple, TenantId, TopicOrSubjectId, Tuple,
    UserId,
};
